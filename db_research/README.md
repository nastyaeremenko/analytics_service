...
### Выводы
Загрузка товаров в Vertica медленнее примерно в 159 раз, также скорость получения данных для ClickHouse тоже меньше, чем для Vertica, 10млн записей ClickHouse обрабатывается примерно столько же, сколько 1млн в Vertica.