...
### Выводы
Загрузка товаров медленнее примерно в 159 раз в связи с этим считаем дальнейшее тестирование нецелесообразным, т.к. скорость загрузки данных является для нас очень важным фактором.